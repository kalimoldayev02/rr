...
#[OA\Post(path: '/api/events/{eventId}/results', tags: ['Event Results'])]
...
{
    #[Route(route: '/api/events/<eventId:uuid>/results', name: 'events.results.add', methods: ['POST'], group: 'auth_api')]
