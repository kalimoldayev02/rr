...
#[OA\Put(path: '/events/{eventId}/results/{eventResultId}', tags: ['Event Results'])]
...
{
    #[Route(route: '/events/<eventId:uuid>/results/<eventResultId:uuid>', name: 'events.results.update', methods: ['PUT'], group: 'auth_api')]
